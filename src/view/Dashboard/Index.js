            ...
            <div className="col-xl-4 col-sm-6 m-t35">
              <div className="card card-coin">
                <div className="card-body text-center">
                  ...
                  <h2 className="text-black mb-2 font-w600">No. Of Registered Member</h2>
            ...
            <div className="col-xl-4 col-sm-6 m-t35">
              <div className="card card-coin">
                <div className="card-body text-center">
                  ...
                  <h2 className="text-black mb-2 font-w600">No. of Events on App</h2>
                  <p className="mb-0 fs-14">
                    <svg
                      width={29}
                      height={22}
            ...
            <div className="col-xl-4 col-sm-6 m-t35">
              <div className="card card-coin">
                <div className="card-body text-center">
                  ...
                  <h2 className="text-black mb-2 font-w600">No. of Social Posts</h2>
                  <p className="mb-0 fs-14">
                    <svg
                      width={29}
                      height={22}
            ...
            {/* <div className="col-xl-3 col-sm-6 m-t35">
              <div className="card card-coin">
                <div className="card-body text-center">
                  ...
                  <h2 className="text-black mb-2 font-w600">No. of Registered Non Member</h2>
                  <p className="mb-0 fs-14">
                    <svg
                      width={29}
                      height={22}
