...
// import { useL } from "../../Providers/NewsRightSidebar";
import { useLearningRightSidearContext } from "../../Providers/LearningRightSidebar";
...
function Appearnce() {
  ...
  const { component, setRenderComponent } = useLearningRightSidearContext();
      ...
      <DashboardUi>
        ...
        <div className="col-lg-8 col-xl-8 col-md-8 col-12">
          ...
          {loading && <MobileScreenLoader />}
            {!loading && (
              <>
                {id == "644a6d47cf6267a1dbfe7e7a" && (
                  <Learning1 fetch={fetch} elementList={elementList} />
                )}
                {id == "644a6d92cf6267a1dbfe7e94" && (
                  <Learning2 fetch={fetch} elementList={elementList} />
                )}
              </>
            )}
            {/* <News/> */}
